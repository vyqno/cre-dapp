...
contract AgentRegistryTest is Test {
    ...
    function test_RegisterAgent() public {
        uint256 agentId = registry.registerAgent(
            agentWallet, "YieldBot Alpha", "yield_farming", "Automated yield farming across Aave and Compound"
        );
